...
led_used		= 1
led_num	 	 	= 3
led1			= port:PH20<1><default><default><default>
led1_trigger		= "none"
led2			= port:PH21<1><default><default><default>
led2_trigger		= "none"
led3			= port:PH22<1><default><default><default>
led3_trigger		= "none"
...
phy-rst            = port:PA17<1><1><1><0>
gmac_power1        = "vcc-pa:2500000"
gmac_power2        = "ephy-dvdd33:0"
gmac_power3        = ""
tx-delay           = 0
rx-delay           = 0
...
[can0]
can0_used        = 0
can0_tx          = port:PH20<4><default><default><default>
can0_rx          = port:PH21<4><default><default><default>

[can0_suspend]
can0_tx          = port:PH20<7><default><default><default>
can0_rx          = port:PH21<7><default><default><default>
...
uart1_dtr        = port:PA14<7><1><default><default>
uart1_dsr        = port:PA15<7><1><default><default>
uart1_dcd        = port:PA16<7><1><default><default>
uart1_ring       = port:PA17<7><1><default><default>

[uart2]
uart2_used       = 0
uart2_port       = 2
uart2_type       = 4
uart2_tx         = port:PA02<4><1><default><default>
uart2_rx         = port:PA03<4><1><default><default>
uart2_rts        = port:PA00<4><1><default><default>
uart2_cts        = port:PA01<4><1><default><default>

[uart2_suspend]
uart2_tx         = port:PA02<7><1><default><default>
uart2_rx         = port:PA03<7><1><default><default>
uart2_rts        = port:PA00<7><1><default><default>
uart2_cts        = port:PA01<7><1><default><default>
...
uart4_rx         = port:PG10<4><1><default><default>

[uart4_suspend]
uart4_tx         = port:PG10<7><1><default><default>
uart4_rx         = port:PG10<7><1><default><default>
...
[uart5_suspend]
uart5_tx         = port:PH06<3><1><default><default>
uart5_rx         = port:PH07<3><1><default><default>

[uart6]
uart6_used       = 0
uart6_port       = 6
uart6_type       = 2
uart6_tx         = port:PA12<3><1><default><default>
uart6_rx         = port:PA13<3><1><default><default>
...
uart7_port       = 6
uart7_type       = 2
uart7_tx         = port:PA14<3><1><default><default>
uart7_rx         = port:PA15<3><1><default><default>

[uart7_suspend]
uart7_tx         = port:PA14<7><1><default><default>
uart7_rx         = port:PA15<7><1><default><default>
...
regulator_count = 20
regulator1      = "axp221s_dcdc1 none vcc-hdmi vcc-io vcc-dsi vcc-usb vdd-efuse vcc-hp vcc-audio vcc-emmc vcc-card vcc-pc vcc-pd vcc-3v vcc-tvout vcc-tvin vcc-emmcv vcc-sdcv vcc-sdcvq33 vcc-sdcvd vcc-nand vcc-sdcv-p3 vcc-sdcvq33-p3 vcc-sdcvd-p3"
...
;lv<x>volt        : voltage in mV of certain level.
;----------------------------------------------------------------------------------
